...
"""
This is the same Scenario as simple_base.py except in this version, 
the agent observations are sorted based on longitudinal position
"""
class ScenarioSorted(BaseScenario):
